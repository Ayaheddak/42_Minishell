...
#    Updated: 2022/10/16 04:10:05 by aheddak          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS	=	parsing/lexer_1.c parsing/main.c parsing/token.c parsing/utils.c parsing/lexer_2.c parsing/parser.c \
			...
			env_variables/env_list.c env_variables/env_list_utils.c parsing/parsing_utils.c parsing/expansion.c\
...
CFLAGS	=	 -Wall -Wextra -Werror -fsanitize=address -g3 #-I /Users/het-tale/goinfre/.brew/Cellar/readline/8.2.1/include/ -fsanitize=address
...
$(NAME)	:	$(UTILS)	
	@$(CC) $(CFLAGS) $(UTILS) -o $(NAME) -lreadline -g #-L /Users/het-tale/goinfre/.brew/Cellar/readline/8.2.1/lib  -g
