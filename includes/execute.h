...
/*   Updated: 2022/10/07 20:56:36 by het-tale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	input_output(int i, t_execute *exec, t_list *exec_list);
void	ft_error(char *str);
void	close_pipes(t_execute *exec, int n);
void	close_and_free(t_execute exec, int n);
void    file_exist(int  *d, t_execute *exec, t_list *exec_list);
#endif